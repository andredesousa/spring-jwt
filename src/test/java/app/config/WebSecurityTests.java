...
public class WebSecurityTests {
    ...
    void configureAuthenticationManagerBuilder() throws Exception {
        ...
        verify(dao).passwordEncoder(any(BCryptPasswordEncoder.class));
    }

    @Test
    @DisplayName("#passwordEncoder returns a BCryptPasswordEncoder instance")
    void passwordEncoder() {
        assertThat(webSecurity.passwordEncoder()).usingRecursiveComparison().isEqualTo(new BCryptPasswordEncoder());
    }
