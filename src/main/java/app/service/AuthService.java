...
public class AuthService {
    ...
    private final String authoritiesKey = "authorities";
    ...
    public UserDetailsDto login(AuthDto auth) {
        ...
        return new UserDetailsDto(user.getUsername(), null, accessToken, user.getAuthorities());
    }
    ...
    public Authentication validate(String bearerToken) {
        ...
        Collection<Map<String, String>> roles = (Collection<Map<String, String>>) claims.get(authoritiesKey);
        List<GrantedAuthority> authorities = roles.stream()
            .map(role -> new SimpleGrantedAuthority(role.get(authorityKey)))
